...
class PhotographActivity : AppCompatActivity() {
    ...
    protected lateinit var photographImage : ImageView
    protected lateinit var photographState : TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        photographState = findViewById(R.id.photographState)
        photographImage = findViewById(R.id.photographImage)
        textureView = findViewById(R.id.photographSurface)
    ...
    protected fun _setState(text : String){
        photographState.text = text
    }

    fun onTakePhoto1Click(view : View){
        val i = Intent(MediaStore.ACTION_IMAGE_CAPTURE)
        startActivityForResult(i, 101)
    }

    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    fun onTakePhoto2Click(view : View){
        takePicture()
    }

    fun onShowImage2Click(view : View){
            ...
            cameraDevice!!.createCaptureSession(
                ...
                object : CameraCaptureSession.StateCallback() {
                    ...
                    override fun onConfigureFailed(cameraCaptureSession: CameraCaptureSession) {
                        _setState("Configuration change")
                    }
                },
                null
            )
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == REQUEST_CAMERA_PERMISSION) {
            if (grantResults[0] == PackageManager.PERMISSION_DENIED) {
                // close the app
                    _setState("Sorry!!!, you can't use this app without granting permission")
                    finish()
            }
        }
    }
